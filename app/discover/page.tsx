  ...
  if (authLoading || loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100">
        <div className="text-rose-500 text-lg animate-pulse">Loading profiles...</div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-rose-100 flex flex-col">
      ...
      <header className="flex items-center justify-between px-6 py-4">
        <h1 className="text-2xl font-bold" style={{ color: "#DC143C" }}>Lovelle</h1>
      ...
      {matchEffect && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="bg-white rounded-3xl p-8 text-center animate-bounceIn shadow-2xl">
            ...
            <h2 className="text-2xl font-bold text-rose-600 mb-2">It&apos;s a Match!</h2>
          ...
          <div className="w-full max-w-sm">
            ...
            <div className="flex justify-center gap-4 mt-6">
              ...
              <button onClick={() => handleLike(false)} disabled={actionLoading}
                className="w-14 h-14 rounded-full bg-gradient-to-r from-pink-500 to-rose-500 shadow-lg shadow-pink-500/30 flex items-center justify-center text-2xl text-white hover:shadow-pink-500/50 transition disabled:opacity-50">
                💕
              </button>
            </div>
          </div>
